...
public class MainPackageUseExamples {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < laps; i++) {
			...
			System.out.println("The last lap took " + myWatch.markLapDown() + "ms. Total Elapsed time is " + myWatch.getElapsedTime() + "ms.");
		}
		
		Thread.sleep(60*1000);	
		myWatch.stop();
		System.out.println("Total running time = " + myWatch.getElapsedTime() + "ms (˜" + myWatch.getElapsedTime() / 1000 + "s).");
